...
def dashboard():
    ...
    active_bookings = current_user.bookings.filter_by(status='active').join(ParkingSlot).all()
    return render_template('dashboard.html', active_bookings=active_bookings)
